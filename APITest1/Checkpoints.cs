...
namespace Script
{
    ...
    public partial class WorkFlowScript
    {
        ...
        private void set_StServiceCallActivity13_checkpoints(STActivityBase activity)
        {
            ...
            BindDirection actualBindDirection2 = new BindDirection(_flow.StServiceCallActivity13, actualValueGetter2, actualValueSetter2);
            ...
            BindDirection actualBindDirection3 = new BindDirection(_flow.StServiceCallActivity13, actualValueGetter3, actualValueSetter3);
            CpValObj valueActualObject3 = new CpValObj(actualBindDirection3, XmlTypeCode.Float, false);
            CpValObj valueExpectedObject3 = new CpValObj("640", XmlTypeCode.Float);
