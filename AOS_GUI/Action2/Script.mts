...
Browser("Advantage Shopping").Page("Advantage Shopping").WebElement("HP ELITEPAD 1000 G2 TABLET_2").Check CheckPoint("HP ELITEPAD 1000 G2 TABLET") @@ script infofile_;_ZIP::ssf6.xml_;_
...
Browser("Advantage Shopping").Page("Advantage Shopping").Link("cdion My account My orders").Click @@ script infofile_;_ZIP::ssf9.xml_;_
Browser("Advantage Shopping").Page("Advantage Shopping").Link("Sign out").Click @@ script infofile_;_ZIP::ssf10.xml_;_
Browser("Advantage Shopping").Page("Advantage Shopping").Link("dvantage DEMO").Click @@ script infofile_;_ZIP::ssf11.xml_;_
